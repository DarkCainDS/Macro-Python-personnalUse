...
for plantilla in Diego1000:
    ...
    max_value_diego1000 = max(max_value_diego1000)
for plantilla in Diego1001:
    max_value_diego1001 = encontrar_plantilla(imagen, plantilla)
    max_value_diego1001= max(max_value_diego1001)
for plantilla in Diego1002:
    max_value_diego1002 = encontrar_plantilla(imagen, plantilla)
    max_value_diego1002 = max(max_value_diego1002)
    
end_time = time.time()
elapsed_time = end_time - start_time
print('Minirana:', max_value_minirana)
print('Darkcloud:', max_value_darkcloud)
print('Diego1000:', max_value_diego1000)
print('Diego1001:', max_value_diego1001)
print('Diego1002:', max_value_diego1002)
